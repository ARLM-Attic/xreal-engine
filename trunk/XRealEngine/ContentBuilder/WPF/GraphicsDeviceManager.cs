...
namespace XRealEngine.Windows.WPF
{
    public class GraphicsDeviceManager : IGraphicsDeviceService, IDisposable, IGraphicsDeviceManager
    {
        ...
        public GraphicsDeviceManager(Game game)
        {
            ...
            {
                throw new ArgumentException("Graphics device manager is allready present");
            }
        ...
        private void CheckForAvailableSupportedHardware()
        {
            ...
            if (!flag)
            {
                ...
                {
                    throw this.CreateNoSuitableGraphicsDeviceException("No Direct3D Acceleration Desktop", null);
                }
                throw this.CreateNoSuitableGraphicsDeviceException("No Direct3D Acceleration", null);
            }
            if (!flag2)
            {
                throw this.CreateNoSuitableGraphicsDeviceException("No Pixel Shader Support", null);
            }
        }
        ...
        private void CreateDevice(GraphicsDeviceInformation newInfo)
        {
            ...
            {
                throw this.CreateNoSuitableGraphicsDeviceException("Direct3D not avaible", exception);
            }
            catch (DriverInternalErrorException exception2)
            {
                throw this.CreateNoSuitableGraphicsDeviceException("Direct3D internal error" , exception2);
            }
            catch (ArgumentException exception3)
            {
                throw this.CreateNoSuitableGraphicsDeviceException("Invalid create parameter", exception3);
            }
            catch (Exception exception4)
            {
                throw this.CreateNoSuitableGraphicsDeviceException("Create 3D error", exception4);
            }
        ...
        private GraphicsDeviceInformation FindBestPlatformDevice(bool anySuitableDevice)
        {
            ...
            {
                throw this.CreateNoSuitableGraphicsDeviceException("No compatible device", null);
            }
            this.RankDevices(foundDevices);
            if (foundDevices.Count == 0)
            {
                throw this.CreateNoSuitableGraphicsDeviceException("No compatible device after ranking", null);
            }
        ...
        private void ValidateGraphicsDeviceInformation(GraphicsDeviceInformation devInfo)
        {
            ...
            {
                throw new ArgumentException("Backbuffer format is invalid");
            }
            ...
            {
                throw new ArgumentException("Backbuffer count is invalid");
            }
            if ((presentationParameters.BackBufferCount > 1) && (presentationParameters.SwapEffect == SwapEffect.Copy))
            {
                throw new ArgumentException("Backbuffer swap copies count is invalid");
            }
                ...
                case SwapEffect.Copy:
                    {
                        ...
                        {
                            throw new ArgumentException("Multi sample is invalid");
                        }
                        if (presentationParameters.MultiSampleQuality >= num3)
                        {
                            throw new ArgumentException("Multi sample quality is invalid");
                        }
                        if ((presentationParameters.MultiSampleType != MultiSampleType.None) && (presentationParameters.SwapEffect != SwapEffect.Discard))
                        {
                            throw new ArgumentException("Multi sample swap is invalid");
                        }
                        ...
                        {
                            throw new ArgumentException("Auto depth is invalid");
                        }
                        if (presentationParameters.EnableAutoDepthStencil)
                        {
                            ...
                            {
                                throw new ArgumentException("Auto depth format is invalid");
                            }
                            if (!adapter.CheckDepthStencilMatch(deviceType, format, format4, presentationParameters.AutoDepthStencilFormat))
                            {
                                throw new ArgumentException("Auto depth is not compatible");
                            }
                        }
                        if (!presentationParameters.IsFullScreen)
                        {
                            ...
                            {
                                throw new ArgumentException("Refresh rate is invalid");
                            }
        ...
        public ShaderProfile MinimumPixelShaderProfile
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("value", "Refresh rate is invalid");
                }
